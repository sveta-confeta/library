...
export const BottomIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg width="14" height="8" viewBox="0 0 14 8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <defs>
            <linearGradient id="paint0_linear_14406_29395" x1="6.74785" y1="-14.875" x2="-23.3724" y2="26.9297" gradientUnits="userSpaceOnUse">
